...
data class TelemetrySample(
    ...
    // Honda enhanced/module values. These remain null until commands are verified for Elizabeth.
    val cvtFluidC: Double? = null,
    val cvtInputRpm: Double? = null,
    val cvtOutputRpm: Double? = null,
    val cvtRatio: Double? = null,
    val cvtLockupPercent: Double? = null,
    val knockControlPercent: Double? = null,
    val batteryCurrentAmps: Double? = null,
    val batteryStateOfChargePercent: Double? = null,
    val chargingCommandPercent: Double? = null,
    val wheelSpeedFrontLeftKph: Double? = null,
    val wheelSpeedFrontRightKph: Double? = null,
    val wheelSpeedRearLeftKph: Double? = null,
    val wheelSpeedRearRightKph: Double? = null,
    val steeringAngleDegrees: Double? = null,
    val yawRateDegreesPerSecond: Double? = null,
    val lateralAccelerationG: Double? = null,
    val longitudinalAccelerationG: Double? = null,
    val brakePressureBar: Double? = null,
    val tractionControlActive: Boolean? = null,
    val tirePressureFrontLeftKpa: Double? = null,
    val tirePressureFrontRightKpa: Double? = null,
    val tirePressureRearLeftKpa: Double? = null,
    val tirePressureRearRightKpa: Double? = null,
)
